...
class EmbeddingGui(FigureCanvas):
    ...
    def display_images_on_hover(self, selected_indexes, landmark_orig_indexes):
        ...
        for index in selected_indexes:
            ...
            img_path = f"C:\\Users\\alexa\\Desktop\\Frames_val\\{landmark_orig_indexes[index]}.jpg"
...
class EmbeddingViewer(QtWidgets.QWidget):
    ...
    def on_selection(self, indexes, selection_event, landmark_orig_indexes, bool_annotate):
        ...
        if selection_event is SelectionEvent.PERMANENT:
            ...
            if len(indexes) == 0:
                ...
                image_path = f"C:\\Users\\alexa\\Desktop\\Frames_val\\{landmark_orig_indexes[indexes[-1]]}.jpg"
    ...
    def update_annotation_file(self, indexes, landmark_orig_indexes, name_anno):
        path_to_placeholder_file = "C:\\Users\\alexa\\Desktop\\Val_set_hsne\\annotation_file_placeholder.json"
        path_to_annotation_file = "C:\\Users\\alexa\\Desktop\\Val_set_hsne\\annotation_file.json"
        path_to_metadata = "C:\\Users\\alexa\\Desktop\\Val_set_hsne\\anno_val_set_segm.csv"
